...
class ClientTest(unittest.TestCase):
    ...
    def test_validate_client(self):
        ...
        self.assertRaisesRegex(ValueError, validator.validate_client(client2))
        self.assertRaisesRegex(ValueError, validator.validate_client(client3))
        self.assertRaisesRegex(ValueError, validator.validate_client(client4))
...
class MovieTest(unittest.TestCase):
    ...
    def test_validate_movie(self):
        ...
        self.assertRaisesRegex(ValueError, validator.validate_movie(movie1))
        self.assertRaisesRegex(ValueError, validator.validate_movie(movie2))
        self.assertRaisesRegex(ValueError, validator.validate_movie(movie3))
        self.assertRaisesRegex(ValueError, validator.validate_movie(movie4))

...
inputClient =  r'Q:\info\python\lab7-9copie2\inputs\inputClient.txt'
inputRental = r'Q:\info\python\lab7-9copie2\inputs\inputRental.txt'
inputMovie=  r'Q:\info\python\lab7-9copie2\inputs\inputMovie.txt'
    #pc personal
